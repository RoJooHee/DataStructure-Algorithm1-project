...
public class DonggukGameSoft {
	...
	public static void main(String[] args) {
		...
		for(int k=1; k<=3; k++) {
			...
			int num30 = nth_element(data, 0, n-1, (int)q30+1); //30퍼센트에 해당하는 k번쨰로 큰 값을 num30으로 함
			int p_30=quicksort1(data, p_avg, n-1, num30); //30퍼 값을 pivot으로 했을 때 상위 절반정도 퀵정렬 후 pivot의 인덱스
			
			quicksort2(data, p_30, n-1); //30퍼부터 1등까지 재귀적 퀵정렬해서 전부 정렬
